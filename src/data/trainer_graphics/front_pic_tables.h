...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(BRENDAN, gTrainerFrontPic_Protag1, 0x800),
    TRAINER_SPRITE(MAY, gTrainerFrontPic_Protag2, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(BRENDAN, gTrainerPalette_Protag1),
    TRAINER_PAL(MAY, gTrainerPalette_Protag2),
