 ...
 * Task_NewGameBirchSpeech_StartBirchSylveonPlatformFade
 * Task_NewGameBirchSpeech_StartBirchSylveonPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchSylveon
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForSylveon
 * Task_NewGameBirchSpeechSub_WaitForSylveon
...
static void Task_NewGameBirchSpeechSub_WaitForSylveon(u8);
static void Task_NewGameBirchSpeech_StartBirchSylveonPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchSylveon(u8);
...
#define tSylveonSpriteId data[9]
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForSylveon;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForSylveon(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tSylveonSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(1);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchSylveonPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchSylveonPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        gSprites[gTasks[taskId].tSylveonSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tSylveonSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    ...
    {
        FreeAllWindowBuffers();
        FreeAndDestroyMonPicSprite(gTasks[taskId].tSylveonSpriteId);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchSylveon;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchSylveon(u8 taskId)
{
    u8 spriteId;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tSylveonSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tSylveonSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreateSylveonSprite(u8 a, u8 b)
{
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    sylveonSpriteId = NewGameBirchSpeech_CreateSylveonSprite(100, 0x4B);
    gSprites[sylveonSpriteId].callback = SpriteCB_Null;
    gSprites[sylveonSpriteId].oam.priority = 0;
    gSprites[sylveonSpriteId].invisible = TRUE;
    gTasks[taskId].tSylveonSpriteId = sylveonSpriteId;
